...
export default function Terms() {
  return (
    <LegalShell title="Terms of Service" updated="27 July 2026">
      <div className="lede">
      ...
      <h2>5. Emails from us</h2>
      <p>
        Requesting our checklist signs you up to receive it by email, along with occasional emails from us &mdash;
        automation tips and, now and then, an offer. You can unsubscribe at any time using the link in any email or by
        writing to <a href="mailto:brooks@erasefriction.com">brooks@erasefriction.com</a>, and we&rsquo;ll stop. How we
        handle your information is described in our <a href="/privacy">Privacy Policy</a>.
      </p>
